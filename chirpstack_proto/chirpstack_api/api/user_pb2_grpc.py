...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in api/user_pb2_grpc.py depends on'
...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                ...
                response_deserializer=api_dot_user__pb2.GetUserResponse.FromString,
                _registered_method=True)
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Get': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=api_dot_user__pb2.GetUserResponse.SerializeToString,
            ),
...
class UserService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            api_dot_user__pb2.GetUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
